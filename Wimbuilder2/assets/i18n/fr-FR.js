...
$i18n = {
  ...
  "<strong>INFO</strong>:The install.wim does not exist.":"<strong>INFO</strong>:le fichier 'Install.wim' n'existe pas.",
  "Select the install.wim file if it needed":"Sélectionnez le fichier 'Install.wim' si nécessaire",
  "<strong>ERROR</strong>:The base wim does not exist.":"<strong>ERROR</strong>:le fichier de base Wim n'existe pas.",
